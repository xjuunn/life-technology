            ...
            <section id="solution" class="scroll-mt-24">
              ...
              <div class="grid sm:grid-cols-2 gap-4 not-prose my-8">
                <div v-for="(item, i) in 6" :key="i" class="card bg-base-200/50 border border-base-content/5 p-6">
                  <h4 class="font-bold text-lg mb-2 text-primary">{{ t(`wp.content.solution_point_${i + 1}_title`) }}</h4>
              ...
              <div class="card bg-primary text-primary-content not-prose mb-8">
                <div class="card-body">
                  ...
                  <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h4 class="font-bold mb-2 opacity-80 border-b border-white/20 pb-1">Web3 Security Core</h4>
                      <ul class="list-disc list-inside text-sm space-y-1">
                        <li>Secure Element (SE) Asset Vault</li>
                        <li>NFC for offline encrypted payments</li>
                ...
                <table class="table table-zebra bg-base-100 border border-base-content/10">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>80%</td>
                      <td>1,680,000,000</td>
                      <td>Proof-of-Health mining; 4-year halving</td>
                    </tr>
                    <tr>
                      <td>Ecosystem Reserve</td>
                      <td>10%</td>
                      <td>210,000,000</td>
                      <td>48-month linear vesting</td>
                    </tr>
                    <tr>
                      <td>Marketing</td>
                      <td>4.76%</td>
                      <td>100,000,000</td>
                      <td>25% at TGE; remaining over 12 months</td>
                    </tr>
                    <tr>
                      <td>Early Contributor Airdrop</td>
                      <td>3.81%</td>
                      <td>80,000,000</td>
                      <td>One-time post-TGE</td>
                    </tr>
                    <tr>
                      <td>Founders & Dev</td>
                      <td>1.43%</td>
              ...
              <ul class="steps steps-vertical w-full not-prose">
                ...
                <li class="step">
                  <div class="text-left ml-4 mb-6">
                    ...
                    <p class="text-sm opacity-70">Developer SDK, Global marketing, DAO transition</p>
                  </div>
                </li>
                <li class="step">
...
<i18n lang="json">{
  "en": {
    "wp": {
      ...
      "title_suffix": "Web3 Social Health Ecosystem",
      "subtitle": "Returning health data sovereignty and digital asset control to users with hardware-level security.",
      "disclaimer": {
        "title": "Disclaimer and Risk Warning",
        "content": "This whitepaper presents the technical vision and roadmap of LifeChain. It does not constitute investment advice or a commitment to purchase. Digital asset investment carries risks. Please evaluate carefully."
      },
      "sections": {
      ...
      "content": {
        "executive_p1": "LifeChain aims to catalyze a paradigm shift in the ownership and value distribution of personal health data. By integrating blockchain, AI, and smart wearables, we build an inclusive and green ecosystem.",
        "executive_p2": "We present a full-stack system consisting of a sovereign high-performance public chain, a secure smartwatch (Watch H) with a built-in hardware security module, and immersive social applications.",
        "intro_lead": "A fundamental contradiction exists: users generate health data, yet receive little value in return.",
        ...
        "intro_point_2_desc": "Traditional incentives are vulnerable to data tampering and fraud.",
        "intro_point_3_title": "Unsustainability",
        "intro_point_3_desc": "Many models rely on high inflation without intrinsic value.",
        ...
        "intro_point_5_desc": "Lack of hardware-level security puts user assets at risk.",
        "solution_point_1_title": "Trusted Data Source",
        "solution_point_1_desc": "Watch H signs data at generation, preventing tampering.",
        "solution_point_2_title": "Value Distribution",
        "solution_point_2_desc": "Smart contracts automate rewards for healthy behavior.",
        "solution_point_3_title": "Data Marketplace",
        "solution_point_3_desc": "Users monetize anonymized data via decentralized exchange.",
        "solution_point_4_title": "Social-Financial Layer",
        "solution_point_4_desc": "Integrates social attributes with financial incentives.",
        "solution_point_5_title": "Asset Security",
        "solution_point_5_desc": "Hardware vault secures all digital assets and identity.",
        "solution_point_6_title": "Green Sustainability",
        "solution_point_6_desc": "Low-power blockchain fosters a green, smart lifestyle.",
        "arch_4_1_title": "LifeChain Public Chain",
        ...
        "arch_4_2_desc": "Adopts Bitcoin-inspired, quantum-resistant cryptography.",
        ...
        "product_app_desc": "The LifeChain Super App serves as the interaction hub. It features a Dashboard, Social Center, Data Marketplace, and Governance Portal, integrated with hybrid payments.",
        "token_name": "Token Name",
        "max_supply": "Max Supply",
        "fixed_supply": "Fixed, No Inflation",
        "governance_desc": "LifeChain's endgame is a community-governed DAO. Voting power is based on staked assets. Topics include technical upgrades, treasury usage, and ecosystem parameters.",
        "market_desc": "Targeting the >$1T global health-tech market and Web3 adoption. Vertical integration of 'Chain + Hardware + App' creates strong moats.",
        "conclusion_desc": "LifeChain breaks centralized monopolies. With 2.1 billion tokens, 80% of which are obtained via healthy behavior, we inaugurate a fair value distribution paradigm."
      }
    }
  },
  "zh-CN": {
    "wp": {
      "toc": "目录",
      "release_date": "发布日期",
      "title_suffix": "Web3 社交健康生态系统",
      "subtitle": "拥有硬件级安全，将健康数据主权和数字资产控制权归还给用户。",
      "disclaimer": {
        "title": "重要声明与风险提示",
        "content": "本白皮书阐述了LifeChain项目的技术愿景和路线图。它不构成投资建议或购买承诺。数字资产投资具有风险，请谨慎评估。"
      },
      "sections": {
        "executive": "执行摘要",
        "intro": "价值困境",
      ...
      "content": {
        "executive_p1": "LifeChain 旨在推动个人健康数据所有权和价值分配的范式转变。通过整合区块链、AI 和智能穿戴设备，我们构建了一个包容且绿色的生态系统。",
        "executive_p2": "我们提供由主权高性能公链、内置硬件安全模块的智能手表 (Watch H) 以及沉浸式社交应用组成的全栈系统。",
        "intro_lead": "存在一个根本矛盾：用户产生健康数据，却几乎没有获得任何价值。",
        "intro_point_1_title": "数据垄断",
        "intro_point_1_desc": "科技巨头垄断用户数据，用户无法有效利用。",
        "intro_point_2_title": "信任赤字",
        "intro_point_2_desc": "传统激励机制易受数据篡改和欺诈影响。",
        "intro_point_3_title": "不可持续",
        "intro_point_3_desc": "许多模式依赖高通胀，缺乏内在价值支撑。",
        "intro_point_4_title": "体验割裂",
        "intro_point_4_desc": "硬件与应用缺乏联动，体验不连贯。",
        "intro_point_5_title": "资产安全",
        "intro_point_5_desc": "缺乏硬件级安全保护，用户资产面临风险。",
        "solution_point_1_title": "可信源头数据",
        "solution_point_1_desc": "Watch H 在生成端签名，从源头防止篡改。",
        "solution_point_2_title": "价值分配引擎",
        "solution_point_2_desc": "智能合约自动分发健康行为奖励。",
        "solution_point_3_title": "数据市场",
        "solution_point_3_desc": "用户通过去中心化市场授权匿名数据获益。",
        "solution_point_4_title": "社交金融层",
        "solution_point_4_desc": "深度融合社交属性与金融激励。",
        "solution_point_5_title": "资产安全堡垒",
        "solution_point_5_desc": "硬件金库保护所有数字资产与身份。",
        "solution_point_6_title": "绿色可持续",
        "solution_point_6_desc": "低能耗区块链，倡导绿色智能生活。",
        "arch_4_1_title": "LifeChain 公链",
        "arch_4_1_li1": "DPoS 共识机制，高效节能。",
        "arch_4_1_li2": "高性能：目标 TPS > 10,000。",
        "arch_4_1_li3": "EVM+ 兼容，支持隐私保护计算。",
        "arch_4_2_title": "Watch H 硬件安全",
        "arch_4_2_desc": "采用受比特币启发的抗量子加密技术。",
        "arch_4_2_li1_t": "安全单元 (SE)",
        "arch_4_2_li1_d": "CC EAL6+ 认证，物理隔离环境。",
        "arch_4_2_li2_t": "自主管理",
        "arch_4_2_li2_d": "私钥永不出芯片，用户拥有完全控制权。",
        "product_app_desc": "LifeChain Super App 是交互中心，包含仪表盘、社交中心、数据市场和治理入口，集成混合支付功能。",
        "token_name": "通证名称",
        "max_supply": "最大供应量",
        "fixed_supply": "固定总量，无增发",
        "governance_desc": "LifeChain 的最终目标是社区治理的 DAO。投票权基于质押资产，议题包括技术升级、国库使用及生态参数调整。",
        "market_desc": "瞄准万亿级全球健康科技市场及 Web3 普及浪潮。「公链+硬件+App」的垂直整合构建了强大的技术护城河。",
        "conclusion_desc": "LifeChain 旨在打破健康数据垄断。21亿 $LIF 通证中80%通过健康行为产出，我们开启了全新的公平价值分配范式。"
      }
    }
  },
  "zh-TW": {
    "wp": {
      "toc": "目錄",
      "release_date": "發布日期",
      "title_suffix": "Web3 社交健康生態系統",
      "subtitle": "擁有硬件級安全，將健康數據主權和數位資產控制權歸還給用戶。",
      "disclaimer": {
        "title": "重要聲明與風險提示",
        "content": "本白皮書闡述了LifeChain項目的技術願景和路線圖。它不構成投資建議或購買承諾。數位資產投資具有風險，請謹慎評估。"
      },
      "sections": {
        "executive": "執行摘要",
        "intro": "價值困境",
      ...
      "content": {
        "executive_p1": "LifeChain 旨在推動個人健康數據所有權和價值分配的範式轉變。通過整合區塊鏈、AI 和智能穿戴設備，我們構建了一個包容且綠色的生態系統。",
        "executive_p2": "我們提供由主權高性能公鏈、內置硬件安全模組的智能手錶 (Watch H) 以及沉浸式社交應用組成的全棧系統。",
        "intro_lead": "存在一個根本矛盾：用戶產生健康數據，卻幾乎沒有獲得任何價值。",
        "intro_point_1_title": "數據壟斷",
        "intro_point_1_desc": "科技巨頭壟斷用戶數據，用戶無法有效利用。",
        "intro_point_2_title": "信任赤字",
        "intro_point_2_desc": "傳統激勵機制易受數據篡改和欺詐影響。",
        "intro_point_3_title": "不可持續",
        "intro_point_3_desc": "許多模式依賴高通脹，缺乏內在價值支撐。",
        "intro_point_4_title": "體驗割裂",
        "intro_point_4_desc": "硬件與應用缺乏聯動，體驗不連貫。",
        "intro_point_5_title": "資產安全",
        "intro_point_5_desc": "缺乏硬件級安全保護，用戶資產面臨風險。",
        "solution_point_1_title": "可信源頭數據",
        "solution_point_1_desc": "Watch H 在生成端簽名，從源頭防止篡改。",
        "solution_point_2_title": "價值分配引擎",
        "solution_point_2_desc": "智能合約自動分發健康行為獎勵。",
        "solution_point_3_title": "數據市場",
        "solution_point_3_desc": "用戶通過去中心化市場授權匿名數據獲益。",
        "solution_point_4_title": "社交金融層",
        "solution_point_4_desc": "深度融合社交屬性與金融激勵。",
        "solution_point_5_title": "資產安全堡壘",
        "solution_point_5_desc": "硬件金庫保護所有數位資產與身份。",
        "solution_point_6_title": "綠色可持續",
        "solution_point_6_desc": "低能耗區塊鏈，倡導綠色智能生活。",
        "arch_4_1_title": "LifeChain 公鏈",
        "arch_4_1_li1": "DPoS 共識機制，高效節能。",
        "arch_4_1_li2": "高性能：目標 TPS > 10,000。",
        "arch_4_1_li3": "EVM+ 兼容，支持隱私保護計算。",
        "arch_4_2_title": "Watch H 硬件安全",
        "arch_4_2_desc": "採用受比特幣啟發的抗量子加密技術。",
        "arch_4_2_li1_t": "安全單元 (SE)",
        "arch_4_2_li1_d": "CC EAL6+ 認證，物理隔離環境。",
        "arch_4_2_li2_t": "自主管理",
        "arch_4_2_li2_d": "私鑰永不出芯片，用戶擁有完全控制權。",
        "product_app_desc": "LifeChain Super App 是交互中心，包含儀表盤、社交中心、數據市場和治理入口，集成混合支付功能。",
        "token_name": "通證名稱",
        "max_supply": "最大供應量",
        "fixed_supply": "固定總量，無增發",
        "governance_desc": "LifeChain 的最終目標是社區治理的 DAO。投票權基於質押資產，議題包括技術升級、國庫使用及生態參數調整。",
        "market_desc": "瞄準萬億級全球健康科技市場及 Web3 普及浪潮。「公鏈+硬件+App」的垂直整合構建了強大的技術護城河。",
        "conclusion_desc": "LifeChain 旨在打破健康數據壟斷。21億 $LIF 通證中80%通過健康行為產出，我們開啟了全新的公平價值分配範式。"
      }
    }
  }
}</i18n>
