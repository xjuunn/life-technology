...
<i18n lang="json">{
  "zh-CN": {
    "what_is_life": {
      ...
      "token": {
        "title": "什么是 LIFE 资产",
        "desc_p1": "LIFE 是 LIFE 生态系统的原生加密资产，在生态内承担多重核心功能。作为基础流通媒介，它支持各类支付、转账和兑换场景；同时赋予持有者治理权，使其能通过提案和投票参与生态决策。LIF还构建了完整的激励体系，用于奖励开发者、内容创作者及节点维护者等。此外，该积分用于覆盖链上交易及智能合约交互产生的手续费，保障网络高效稳定运转。",
        "utility": {
          "payment": "支付流通",
          "governance": "生态治理",
          "incentive": "激励体系"
